...
_UNIVERSE: tuple[IndexUniverseRow, ...] = (
    # Index ETFs
    _row("SPY", "S&P 500 ETF", "INDEX_ETF",
         "672.48", "62.1", "658.20", "642.10", "0.6800", "0.41", "4.2",
         "BULLISH", "4.92",
         watchpoints=("Trend state is bullish; tape support is constructive.",)),
    _row("QQQ", "Nasdaq 100 ETF", "INDEX_ETF",
         "556.71", "65.3", "538.40", "514.20", "0.7400", "0.62", "6.8",
         "BULLISH", "5.18",
         watchpoints=("Trend state is bullish; tape support is constructive.",)),
    _row("DIA", "Dow 30 ETF", "INDEX_ETF",
         "412.80", "55.4", "408.10", "401.40", "0.5600", "0.10", "2.1",
         "WEAK_BULLISH", "3.71"),
    _row("IWM", "Russell 2000 ETF", "INDEX_ETF",
         "214.10", "48.2", "214.60", "212.40", "0.4900", "-0.08", "0.8",
         "NEUTRAL", "1.58"),
    # Sector ETFs
    _row("SMH", "Semiconductor ETF", "SECTOR_ETF",
         "304.55", "72.9", "297.40", "285.30", "0.8700", "1.34", "14.2",
         "BULLISH", "6.92",
         watchpoints=(
             "RSI is elevated; monitor overheat risk.",
             "Trend state is bullish; tape support is constructive.",
         )),
    _row("SOXX", "Semiconductor ETF (iShares)", "SECTOR_ETF",
         "278.20", "70.4", "271.80", "262.40", "0.8200", "1.12", "12.6",
         "BULLISH", "6.18",
         watchpoints=("RSI is elevated; monitor overheat risk.",)),
    _row("XLK", "Technology Sector", "SECTOR_ETF",
         "248.90", "66.1", "242.40", "232.10", "0.7600", "0.84", "8.4",
         "BULLISH", "5.48",
         watchpoints=("Trend state is bullish; tape support is constructive.",)),
    _row("XLF", "Financials Sector", "SECTOR_ETF",
         "52.40", "54.8", "51.80", "50.40", "0.5800", "0.21", "2.4",
         "WEAK_BULLISH", "3.62"),
    _row("XLE", "Energy Sector", "SECTOR_ETF",
         "98.60", "42.1", "99.40", "100.20", "0.4200", "-0.31", "-1.8",
         "WEAK_BEARISH", "-0.18"),
    _row("XLV", "Health Care Sector", "SECTOR_ETF",
         "146.40", "48.6", "146.80", "145.20", "0.4800", "-0.04", "0.4",
         "NEUTRAL", "1.54"),
    _row("XLI", "Industrials Sector", "SECTOR_ETF",
         "134.20", "53.4", "132.80", "129.40", "0.5400", "0.18", "2.8",
         "WEAK_BULLISH", "3.68"),
    _row("XLY", "Consumer Discretionary Sector", "SECTOR_ETF",
         "212.10", "58.1", "208.40", "201.80", "0.6400", "0.42", "4.2",
         "WEAK_BULLISH", "3.92"),
    _row("XLP", "Consumer Staples Sector", "SECTOR_ETF",
         "78.40", "44.2", "78.80", "78.10", "0.4400", "-0.12", "-0.8",
         "WEAK_BEARISH", "-0.08"),
    _row("XLU", "Utilities Sector", "SECTOR_ETF",
         "74.20", "39.4", "75.10", "75.80", "0.3200", "-0.42", "-2.4",
         "BEARISH", "-2.24",
    ...
    IndexUniverseRow(
        ticker="VIX", label="Volatility Index Proxy", kind="MACRO_PROXY",
        latest_close=D("14.62"), latest_time="2026-05-19T00:00:00+00:00",
        rsi_14=D("32.4"), ema_20=D("15.40"), ema_60=D("17.20"),
        bb_position=D("0.2100"), volume_z_score=D("-0.18"),
        momentum_score=D("-12.40"), trend_state="WEAK_BEARISH",
        data_status="OK", relative_strength_score=None,
        watchpoints=["Volatility proxy is easing; macro stress is fading."],
    ),
    IndexUniverseRow(
        ticker="DXY", label="US Dollar Index Proxy", kind="MACRO_PROXY",
        latest_close=D("103.41"), latest_time="2026-05-19T00:00:00+00:00",
        rsi_14=D("48.6"), ema_20=D("103.80"), ema_60=D("104.40"),
        bb_position=D("0.4800"), volume_z_score=D("-0.04"),
        momentum_score=D("-1.20"), trend_state="NEUTRAL",
        data_status="OK", relative_strength_score=None,
        watchpoints=[],
    ),
    IndexUniverseRow(
        ticker="US10Y", label="10Y Treasury Yield Proxy", kind="MACRO_PROXY",
        latest_close=D("4.21"), latest_time="2026-05-19T00:00:00+00:00",
        rsi_14=D("52.1"), ema_20=D("4.18"), ema_60=D("4.12"),
        bb_position=D("0.5400"), volume_z_score=D("0.08"),
        momentum_score=D("0.40"), trend_state="WEAK_BULLISH",
        data_status="OK", relative_strength_score=None,
